  ...
  <el-dialog v-model="dialogFormVisible" title="添加图书" @close="handleClose">
    <el-form ref="formRef" :model="ruleForm" :rules="rules" label-width="70px">
      ...
      <el-form-item label="联系方式" prop="phone">
        <el-input v-model="ruleForm.phone" class="add-form"></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
  ...
  >
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="changeBook">确定</el-button>
      </span>
    </template>
  </el-dialog>
</template>
...
export default {
  ...
  methods: {
    ...
    changeBook() {
      this.$refs.formRef.validate(async (valid) => {
        if (!valid) {
          ...
          let url1 = "/methods/changebook";
          let url2 = "/methods/changephoto";
    ...
    async removeBook(id) {
      const confirmResult = await this.$confirm("是否删除书籍?", "提示", {
    ...
    addBook() {
      ...
      let url1 = "/methods/addbook";
      let url2 = "/methods/addphoto";
      let bookid = "";
